...
'''
*****************************************************
       COMANDOS INTERFAZ GRÁFICA NO DEL CRUD 
*****************************************************
'''
#   Generar una lista para tener una referecia rapida de datos
def listar_asc():
    lista('ASC')
...
def mostrar_acercade():
    messagebox.showinfo('ACERCA DE...',
        'Creado para Codo a Codo 4.0 - \nBig Data/Data analytics\n 2023')

'''
******************************************************
       MENSAJES DE SALIDA/CONTROL INTER. GRÁFICA 
*****************************************************
'''
...
def mensaje_campo_existe_o_no(dato, campo, confirm):
    messagebox.showwarning('ERROR', f'Ese {dato} en el {campo} {confirm} existe')
